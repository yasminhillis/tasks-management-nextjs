    ...
    return (
        <Card extraStyles="shadow-sm w-auto">
                    <div className="flex justify-between mb-[11px] md:mb-[9px]">
                        <div className={`px-[8px] py-[4px] md:px-[10px] md:py-[4px] w-[68px] h-[23px] ${shimmer} rounded-[2px]`}>
                            
                        </div>
                        <div className={`md:hidden w-[4px] h-[13px] ${shimmer}`}>

                        </div>
                        <div className={`hidden md:block w-[16px] h-[4px] ${shimmer}`}>
                           
                        </div>
                    </div>
                    <div className={`w-[192px] h-[23px] mb-[12px] ${shimmer}`}>
                    ...
                    <div className="flex md:justify-between items-center pt-[16px] hidden md:flex">
                        <div className={`w-[48px] h-[12px] rounded-[2px] ${shimmer}`}>
