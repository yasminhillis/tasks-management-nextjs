    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
            <div className="flex flex-col gap-2">
                <label className="uppercase text-xs font-bold" htmlFor="">Email Address</label>

                <div className="relative">
                    <input {...register("email")} className="focus:outline-none focus:border focus:border-primary-container bg-surface-highest p-4 rounded-md text-[#737685] sm:rounded-xs w-full" placeholder="curator@workspace.com"/>
                    <Image className="absolute top-1/2 right-3 -translate-y-1/2 sm:hidden" src="/mail.png" alt="email icon" width={20} height={20}/>
                </div>
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="relative">
                    <input {...register("password")} className="w-full focus:outline-none focus:border focus:border-primary-container  bg-surface-highest p-4 rounded-md text-[#737685] sm:rounded-xs" type="password" placeholder="Enter your password" />
                    <Image className="absolute top-1/2 right-3 -translate-y-1/2 sm:hidden" src="/lock.png" alt="lock icon" width={20} height={20}/>
                </div>
            ...
            <p className="text-slate-600 text-sm text-center mb-4">Don't have an account? <Link href="/signup" className="text-[#003D9B] font-semibold text-sm hover:text-[#2b76e8] transition-colors">Sign Up</Link></p>
        </form>
    )
}