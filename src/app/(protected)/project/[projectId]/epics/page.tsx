...
export default function Epics() {
  ...
  return (
    <PageWrapper>
      <EpicsList projectId={projectId} epics={epics} error={error} loading={loading} currentPage={currentPage} totalCount={totalCount} isFetched={isFetched} onPageChange={fetchEpics} pageSize={EPICS_PAGE_SIZE}/>
