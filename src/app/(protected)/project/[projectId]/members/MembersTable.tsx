...
import DotDropDown from "../../_components/DotDropDown"
...
export default function MembersTable({ data } : MembersTableProps){
        ...
        <tr key={member.member_id}>
                <td className="px-8 py-5 align-middle">
                    <div className="flex items-center gap-4">
                        <Initials name={member.metadata.name} extraStyles="w-[48px] h-[48px] flex items-center justify-center rounded-lg text-[14px] font-bold text-[#003D9B]"/>
    ...
    return <table className="table-fixed w-full rounded-md overflow-hidden p-1 shadow-sm bg-white">
        <thead className="bg-[#E0E8FF4D] w-full h-[54px]">
            <tr>
                ...
                <th className={`w-[169px] ${tableHeaderStyles} text-right`}>Actions</th>
            </tr>
        </thead>
