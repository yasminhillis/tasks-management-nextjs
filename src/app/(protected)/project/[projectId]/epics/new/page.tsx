...
export default async function AddNewEpic({params} : {params: Promise<{projectId: string}>}){
    ...
    <p className="hidden md:block body-lg mb-8 max-w-[472px]">Define a major project phase or high-level milestone to group
        related tasks and track architectural progress.</p>
        <p className="md:hidden body-md mb-[24px]">Define a high-level goal and organizational
structure for your architectural phase.</p>
