  ...
  return (
    <div className="font-sans px-6 pt-8 md:px-8 md:pt-6 mb-30 min-h-screen">
      ...
      <div className="hidden md:flex items-center justify-between mb-10">
        ...
        <button className="hidden md:flex items-center gap-2 px-6 py-3 shadow-blue-md bg-radial from-[#003D9B] to-[#0052CC] text-white text-sm cursor-pointer hover:from-[#1259cb] hover:to-[#0657d1] transition-colors font-bold">
