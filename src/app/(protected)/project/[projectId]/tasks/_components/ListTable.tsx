...
export default function ListTable({ projectId }: { projectId: string }) {
  ...
  const tasks2: Task[] = [
    {
      ...
      id: '3f8a1c22-4e5b-4a6d-9f1e-7c8b9d0a1b2cn',
    ...
    },
    {
      ...
      id: '6c7d8e9f-0a1b-4c2d-9e3f-4a5b6c7d8e9fm',
      project_id: 'ddc3f2e6-588c-41d7-9d2f-3fc43fbf78ea',
      status: 'TO_DO',
      task_id: 'TASK-43',
    ...
    },
    {
      ...
      epic_id: 'c1d4fa7a-3c80-4ea0-8378-d79c7f11bd36',
      id: '3c4d5e6f-7a8b-4c9d-0e1f-2a3b4c5d6e7fq',
      project_id: 'ddc3f2e6-588c-41d7-9d2f-3fc43fbf78ea',
      status: 'DONE',
      task_id: 'TASK-46',
    ...
    },
    {
      ...
      epic_id: 'c1d4fa7a-3c80-4ea0-8378-d79c7f11bd36',
      id: '3c4d5e6f-7a8b-4c9d-0e1f-2a3b4c5d6e7fk',
      project_id: 'ddc3f2e6-588c-41d7-9d2f-3fc43fbf78ea',
      status: 'IN_REVIEW',
      task_id: 'TASK-46',
      title: 'Add Zod schema for task form',
    }, 
    {
      ...
      epic_id: 'c1d4fa7a-3c80-4ea0-8378-d79c7f11bd36',
      id: '3c4d5e6f-7a8b-4c9d-0e1f-2a3b4c5d6e7fv',
      project_id: 'ddc3f2e6-588c-41d7-9d2f-3fc43fbf78ea',
    ...
    }, 
    {
      ...
      created_at: '2026-08-23T11:05:09.870000+00:00',
      created_by: {
        id: '031b7dc1-326c-4f32-b0a6-bf2267b0a8efx',
        name: 'Yasmin Ayman',
        email: 'yasminhillis7@gmail.com',
        department: 'Frontend',
      },
      ...
      epic_id: 'c1d4fa7a-3c80-4ea0-8378-d79c7f11bd36',
      id: '3c4d5e6f-7a8b-4c9d-0e1f-2a3b4c5d6e7fp98',
      project_id: 'ddc3f2e6-588c-41d7-9d2f-3fc43fbf78ea',
      status: 'REOPENED',
      task_id: 'TASK-46',
      title: 'Add Zod schema for task form',
    }, 
    {
      ...
      epic_id: 'c1d4fa7a-3c80-4ea0-8378-d79c7f11bd36',
      id: '3c4d5e6f-7a8b-4c9d-0e1f-2a3b4c5d6e7fs',
      project_id: 'ddc3f2e6-588c-41d7-9d2f-3fc43fbf78ea',
      status: 'READY_FOR_QA',
      task_id: 'TASK-46',
      title: 'Add Zod schema for task form',
    }, 
    {
      ...
      epic_id: 'c1d4fa7a-3c80-4ea0-8378-d79c7f11bd36',
      id: '3c4d5e6f-7a8b-4c9d-0e1f-2a3b4c5d6e7fp',
      project_id: 'ddc3f2e6-588c-41d7-9d2f-3fc43fbf78ea',
      status: 'BLOCKED',
      task_id: 'TASK-46',
      title: 'Add Zod schema for task form',
  ...
  //   READY_FOR_QA: { bg: '#EDE9FE', text: '#5B21B6' },
  ...
  const statusColor = {
    ...
    READY_FOR_QA: { bg: '#EDE9FE', text: '#5B21B6' },
    REOPENED: { bg: '#FFEAD2', text: '#B25E00' },
    READY_FOR_PRODUCTION: { bg: '#CCFBF1', text: '#0D9488' },
    DONE: { bg: '#DCFCE7', text: '#166534' },
  };

  if (taskFetchStatus === 'fetchError') {
    return (
      <ErrorScreen
  ...
  if (taskFetchStatus === 'networkError') {
    return (
      <ErrorScreen
