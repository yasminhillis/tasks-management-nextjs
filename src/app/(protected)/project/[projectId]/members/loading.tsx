...
//   };
  ...
  const memeberElementsMobile = [...Array(4)].map((_, i) => (
        <li key={i} className='flex items-center justify-between bg-white rounded-lg p-4 mb-3'>
          <div className="flex gap-4 items-center">
            <Initials mode="mobile" state='loading' name="" extraStyles={`w-10 h-10 rounded-lg bg-[#D7E2FF] flex items-center justify-center ${loadingStyle}`} />
        ...
        <thead>
            <tr className='align-middle h-[54px] border-b-[#E8EDFF80]'>
                <th className="p-2 align-middle">
                  <div className={`w-[96px] h-[12px] ${loadingStyle} mx-auto`}></div>
                </th>
                <th>
                  <div className={`w-[96px] h-[12px] ${loadingStyle}   mx-auto`}></div>
                </th>
                <th className="">
                  <div className={`w-[64px] h-[12px] ${loadingStyle} mx-auto`}></div>
                </th>
            </tr>
        </thead>
              ...
              <tr key={i}>
                <td className="px-8 py-4 align-middle">
                  <div className="flex gap-[24px] items-center">
                    ...
                    <div className={`${loadingStyle} w-[192px] h-[20px] rounded-[2px]`}></div>
                  </div>
                </td>
                <td className="px-8 py-4 align-middle text-center">
                   <div className="flex justify-center">
                      <Pill role="" extraStyles="" mode="desktop" state="loading"/>
                   </div>
                
                  </td>
                <td>
                  <div className="flex justify-center">
                    <span className={`${loadingStyle} w-[24px] h-[24px] rounded-[2px]`}></span>
                  </div>
                </td>
            </tr>
            ) )}
