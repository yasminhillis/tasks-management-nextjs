...
export default function DotDropDown({ id }: DotDropDownProps){
    ...
    return <div ref={menuRef} className="relative">
                ...
                {isOpen && <div className="absolute top-5 p-4 right-2 w-48 bg-white shadow-sm rounded-sm"><button onClick={() => router.push(`/project/${id}/edit`)} className="curor-pointer">Edit Project</button></div>}
            </div>
}