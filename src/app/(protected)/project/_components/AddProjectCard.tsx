...
export default function AddProjectCard(){
    ...
    return <div onClick={() => router.push('/project/add')} className="hidden md:flex flex-col items-center justify-center h-[220px] bg-white w-full max-w-[304px] rounded-md p-6 border-2 border-dotted border-[#C3C6D633] cursor-pointer">
